...
('benefits_subtitle', 'text', '{"text": "Join hundreds of healthcare facilities that have improved their operations and patient outcomes with CareSync\'s comprehensive management platform."}'),
('cta_title', 'text', '{"text": "Ready to Transform Your Healthcare Operations?"}'),
('cta_subtitle', 'text', '{"text": "Join the CareSync platform and experience the difference comprehensive healthcare management can make for your organization."}'),
