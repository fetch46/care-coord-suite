  ...
  public: {
    Tables: {
      ...
      comprehensive_patient_assessments: {
        ...
        Relationships: [
          {
            foreignKeyName: "comprehensive_patient_assessments_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      patient_caregivers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "patient_caregivers_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      skin_assessments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "skin_assessments_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
