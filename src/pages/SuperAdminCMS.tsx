...
export default function SuperAdminCMS() {
  ...
  return (
    <SuperAdminLayout>
      <div className="space-y-6 max-h-[calc(100vh-6rem)] overflow-auto px-2 pb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
          {content.map((item) => (
            <Card key={item.id} className="relative max-h-[400px] overflow-hidden flex flex-col justify-between">
              ...
              <CardContent className="space-y-4 overflow-auto">
                <div>
                  ...
                  <p className="text-sm bg-muted p-2 rounded line-clamp-3 break-words">
                ...
                >
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      <DialogTitle>
                        Edit {formatContentKey(item.content_key)}
                      </DialogTitle>
                    </DialogHeader>
