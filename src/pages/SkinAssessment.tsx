...
const HOT_SPOTS = [
  "Rime of Ear", "Shoulder Blade", "Elbow", "Sacrum",
  "Hip", "Inner Knee", "Outer Ankle", "Heel"
] as const;
...
export default function SkinAssessmentForm() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      setPhysician(parsed.physician);
      setRoom(parsed.room);
      setRecords(parsed.records);
      setDots(parsed.dots || []);
      setBodyView(parsed.bodyView || "front");
    }
  }, []);
  useEffect(() => {
    localStorage.setItem(
      "skinAssessment",
      JSON.stringify({ date, patientName, physician, room, records, dots, bodyView })
    );
  ...
  const renderAnatomicallyAccurateFront = () => (
    <g stroke="#333" strokeWidth="1.5" fill="none">
      <path d="M200,70 a40,50 0 1,0 0.1,0" fill="#eee" />
      <path d="M180,120 Q200,140 220,120 Q230,150 220,180 Q230,200 230,250 Q230,320 200,320 Q170,320 170,250 Q170,200 180,180 Q170,150 180,120 Z" fill="#eee" />
      <path d="M170,320 L170,600 Q170,640 200,640 Q230,640 230,600 L230,320" fill="#eee" />
      <path d="M170,600 L170,700 Q170,740 200,740 Q230,740 230,700 L230,600" fill="#eee" />
      <path d="M170,700 L160,880 Q190,880 200,860 Q210,880 240,880 L230,700" fill="#eee" />
    </g>
  );

  const renderAnatomicallyAccurateBack = () => (
    <g stroke="#333" strokeWidth="1.5" fill="none">
      <path d="M200,70 a40,50 0 1,0 0.1,0" fill="#eee" />
      <path d="M180,120 Q200,140 220,120 Q230,150 220,180 Q230,200 230,250 Q230,320 200,320 Q170,320 170,250 Q170,200 180,180 Q170,150 180,120 Z" fill="#eee" />
      <path d="M170,320 L170,600 Q170,640 200,640 Q230,640 230,600 L230,320" fill="#eee" />
      <path d="M170,600 L170,700 Q170,740 200,740 Q230,740 230,700 L230,600" fill="#eee" />
      <path d="M170,700 L160,880 Q190,880 200,860 Q210,880 240,880 L230,700" fill="#eee" />
      <line x1="200" y1="150" x2="200" y2="640" stroke="#000" strokeWidth="1" />
    </g>
  );
